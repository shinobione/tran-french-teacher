...
// The Listening engine historically asks for .88 normal / .68 slow.
// voice-ios.js intentionally owns the selected French voice and normally normalizes
// every utterance to Lucie's saved global rate. This bridge preserves the explicit
// Listening rates and calibrates ONLY the slow request to .64, without modifying
// voice-ios.js, pitch, voice choice, or the user's saved Lucie rate.
const LISTENING_RATES = Object.freeze({
  normal: 0.88,
  engineSlow: 0.68,
  slow: 0.64
});
