const CACHE='tran-french-teacher-v1.19.4-b26.4-single-scroll-tyffany';
const V='1.17.0-b24';
...
const CORE=[
  ...
  `./listening-data.js?v=${V}`,`./listening-engine.js?v=${V}`,`./ux-shell.js?v=${UX}`,`./interaction-ux.js?v=${UX}`,`./progression-ux.js?v=${B262}`,`./session-ux.js?v=${P252}`,`./session-ux-adapter.js?v=${P252}`,`./voice-replay.js?v=${B261}`,`./progress-details-dashboard.js?v=${B261}`,`./build26-3-ux.js?v=${B263}`,`./build26-4-ux.js?v=${B264}`,`./build-meta.js?v=${B264}`,`./manifest.webmanifest?v=${V}`,
