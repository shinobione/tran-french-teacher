const CACHE='tran-french-teacher-v1.18.3-b25.3-voice-replay-details-dashboard';
const V='1.17.0-b24';
const UX='1.17.5-b24.5';
const P25='1.18.0-b25';
const P252='1.18.2-b25.2';
const P253='1.18.3-b25.3';
const CORE=[
  './','./index.html',
  ...
  `./scenario-engine.css?v=${V}`,`./real-life-ux.css?v=${V}`,`./error-intelligence.css?v=${V}`,`./listening-engine.css?v=${V}`,`./language-ratio.css?v=${V}`,`./ux-shell.css?v=${UX}`,`./interaction-ux.css?v=${UX}`,`./mobile-polish.css?v=${UX}`,`./progression-ux.css?v=${P25}`,`./session-ux.css?v=${P252}`,`./voice-replay.css?v=${P253}`,`./progress-details-dashboard.css?v=${P253}`,
  ...
  `./listening-data.js?v=${V}`,`./listening-engine.js?v=${V}`,`./ux-shell.js?v=${UX}`,`./interaction-ux.js?v=${UX}`,`./progression-ux.js?v=${P25}`,`./session-ux.js?v=${P252}`,`./session-ux-adapter.js?v=${P252}`,`./voice-replay.js?v=${P253}`,`./progress-details-dashboard.js?v=${P253}`,`./build-meta.js?v=${P253}`,`./manifest.webmanifest?v=${V}`,
