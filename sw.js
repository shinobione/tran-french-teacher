const CACHE='tran-french-teacher-v1.19.5-b26.5-conversation-layout-repair';
const V='1.17.0-b24';
...
const CORE=[
  ...
  `./listening-data.js?v=${V}`,`./listening-engine.js?v=${V}`,`./ux-shell.js?v=${UX}`,`./interaction-ux.js?v=${UX}`,`./progression-ux.js?v=${B265}`,`./session-ux.js?v=${B265}`,`./session-ux-adapter.js?v=${P252}`,`./voice-replay.js?v=${B261}`,`./progress-details-dashboard.js?v=${B261}`,`./build26-3-ux.js?v=${B263}`,`./build26-4-ux.js?v=${B264}`,`./build26-5-ux.js?v=${B265}`,`./build-meta.js?v=${B265}`,`./manifest.webmanifest?v=${V}`,
