...
const CORE=[
  ...
  `./premium-v4-home.css?v=${V5F}`,`./premium-v4-progress.css?v=${V5F}`,`./premium-v4-practice.css?v=${V5F}`,`./premium-v4-listening.css?v=${V5F}`,`./premium-v4-settings.css?v=${V5F}`,`./premium-v4-ownership-hotfix.css?v=${V5F}`,`./premium-v4-route-coherence.css?v=${COHERENCE}`,`./premium-v4-motion.css?v=${MOTION}`,`./premium-v4-contrast.css?v=${V4}`,`./premium-v5-coherence.css?v=${V5}`,`./premium-v5-listening-settings.css?v=${V5}`,`./premium-v5-utility.css?v=${V5U}`,`./premium-v5-islands.css?v=${V5I}`,`./premium-v5-mockup-convergence.css?v=${V5M}`,`./premium-v5-fidelity-reset.css?v=${V5F}`,`./premium-v5-fidelity-refine.css?v=${V5FR}`,`./premium-v5-fidelity-card-hotfix.css?v=${V5FR}`,`./premium-v5-fidelity-settings-hotfix.css?v=${V5FR}`,`./premium-v5-fluidity.css?v=${V59}`,`./premium-nav-geometry-hotfix.css?v=${V5F}`,`./premium-theme-polish.css?v=${V5F}`,`./premium-theme-polish.css?v=${V59}`,
