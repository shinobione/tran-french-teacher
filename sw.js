...
const V5U='2.3.17-v5utility1';
const V5I='2.3.18-v5islands1';
const V5M='2.3.19-v5mockup1';
const V5F='2.3.20-v5fidelity1';
const V5FR='2.3.20-v5fidelity2';
const CORE=[
  './','./index.html',
  ...
  './premium-v4-home.css?v=2.3.6-v4home2','./premium-v4-progress.css?v=2.3.7-v4progress1','./premium-v4-practice.css?v=2.3.8-v4practice1','./premium-v4-listening.css?v=2.3.9-v4listening1','./premium-v4-settings.css?v=2.3.10-v4settings1','./premium-v4-ownership-hotfix.css?v=2.3.11-v4ownership1',`./premium-v4-route-coherence.css?v=${COHERENCE}`,`./premium-v4-motion.css?v=${MOTION}`,`./premium-v4-contrast.css?v=${V4}`,`./premium-v5-coherence.css?v=${V5}`,`./premium-v5-listening-settings.css?v=${V5}`,`./premium-v5-utility.css?v=${V5U}`,`./premium-v5-islands.css?v=${V5I}`,`./premium-v5-mockup-convergence.css?v=${V5M}`,`./premium-v5-fidelity-reset.css?v=${V5F}`,`./premium-v5-fidelity-refine.css?v=${V5FR}`,`./premium-v5-fidelity-card-hotfix.css?v=${V5FR}`,'./premium-nav-geometry-hotfix.css?v=2.3.4-p0nav1',`./premium-theme-polish.css?v=${V5M}`,
  `./data-recovery-core.js?v=${B28}`,`./data-recovery.js?v=${B28}`,
  `./progress-safety.js?v=${V}`,`./app.js?v=${V}`,`./curriculum-stage2.js?v=${V}`,`./curriculum-stage3.js?v=${V}`,`./stage2-boot.js?v=${NAV}`,`./field-navigation-runtime.js?v=${NAV}`,`./field-audio-session.js?v=${AUDIO}`,`./theme-controller.js?v=${V5M}`,`./premium-v5-fidelity-reset.js?v=${V5F}`,
