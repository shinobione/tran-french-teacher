...
t=t.replace('- **Build 20 — Listening Comprehension**','- **Build 20 — Listening Comprehension**\n- statut : **PROD / GitHub Pages**')
t=t.replace('> Build 20 reste candidat tant que PR, CI `main`, GitHub Pages et rendu public ne sont pas tous validés.','> Build 20 a été validé sur PR, sur `main`, sur GitHub Pages puis directement sur l’URL publique, y compris le comportement transcript caché → révélé.')
...
t=t.replace('> Reste dans Unreleased jusqu’à la preuve PR + main + Pages + rendu public.\n','')
marker='- CI prévue Home / Listening / Scenario / Error / A1 Core.\n'
if marker in t and 'rendu public Listening' not in t:
    t=t.replace(marker,marker+'- PR #13 validée puis squash-mergée ;\n- Chrome Home / Listening / Scenario / Error / A1 Core validés sur PR puis sur `main` ;\n- GitHub Pages validé ;\n- rendu public Listening validé avec transcript caché avant réponse, révélé après et preuve `listening-miss`.\n')
p.write_text(t,encoding='utf-8')
...
p=Path('docs/BUILD-20-LISTENING.md')
t=p.read_text(encoding='utf-8')
...
print('Build 20 release docs closed')
