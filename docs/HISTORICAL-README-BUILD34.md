# French Trân’quille — historical README snapshot

> Archived on 2026-08-17 during PR #201.
>
> This file preserves the previous README as historical evidence. It is **not** the current project checkpoint and must not override `PROJECT-STATE.md` or `MASTER-ROADMAP.md`.
