(() => {
  ...
  function answer(button){if(session?.answered||button.dataset.foundationBusy==='1')return;button.dataset.foundationBusy='1';session=engine.reduce(activeCapsule,session,{type:'ANSWER',choice:button.dataset.foundationChoice});renderOverlay()}
