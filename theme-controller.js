...
function ensureStyle(){
 ...
 if(!document.querySelector('script[data-premium-v59-runtime]')){
  const r=document.createElement('script');r.src='./premium-v5-fluidity.js?v=2.3.23-v59ui1';r.dataset.premiumV59Runtime='1';r.async=false;document.head.appendChild(r);
 }
...
function apply(id){const t=valid(id);document.documentElement.dataset.theme=t;if(localStorage.getItem(KEY)!==t)localStorage.setItem(KEY,t);sync(t);window.FrenchTranquillePremiumV55?.refresh?.();window.FrenchTranquillePremiumV59?.refresh?.();return t}
