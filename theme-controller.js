...
function apply(id){const t=valid(id);document.documentElement.dataset.theme=t;if(localStorage.getItem(KEY)!==t)localStorage.setItem(KEY,t);sync(t);window.FrenchTranquillePremiumV55?.refresh?.();window.FrenchTranquillePremiumV59Interactions?.refresh?.();return t}
...
function mount(){brand();picker();sync(current());window.FrenchTranquillePremiumV55?.refresh?.();window.FrenchTranquillePremiumV59Interactions?.refresh?.()}
...
window.FrenchTranquilleThemes=Object.freeze({version:'1.4.0-v59a1',key:KEY,themes:IDS,current,apply,mountBrand:brand,mountSettingsPicker:picker,mount});
})();
